...
- [ ] Match the Customer Home typography hierarchy to the verified Cerimonia reference system.
- [ ] Apply the new warm-stone Customer Home palette while preserving Tklh green.
- [ ] Re-verify `/` at 375px, 768px, and 1440px in Arabic and English; pass build/typecheck.
