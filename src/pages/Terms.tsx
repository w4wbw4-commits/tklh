...
const Terms = () => {
  ...
  useEffect(() => {
    document.title = `${t("terms.tosTitle")} · TKLH`;
  }, [t]);
  ...
  return (
    <div className="min-h-screen bg-gradient-soft">
      <SEO
        title={`${t("terms.tosTitle")} | TKLH`}
        description={t("terms.tosIntro", { defaultValue: "شروط استخدام منصة تِكله TKLH لتخطيط وحجز المناسبات في السعودية." }) as string}
        canonical="/terms"
      />
