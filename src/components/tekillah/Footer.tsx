...
const PinterestIcon = forwardRef<SVGSVGElement, { className?: string }>(({ className }, ref) => (
...
const SnapchatIcon = forwardRef<SVGSVGElement, { className?: string }>(({ className }, ref) => (
  <svg ref={ref} viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
...
const WhatsAppIcon = forwardRef<SVGSVGElement, { className?: string }>(({ className }, ref) => (
  <svg ref={ref} viewBox="0 0 32 32" fill="currentColor" className={className} aria-hidden="true">
          ...
          <div className="col-span-2 md:col-span-2 md:pe-10">
            ...
            <div className="mt-6 flex items-center gap-5">
              {[
                ...
                { Icon: WhatsAppIcon, href: "https://wa.me/966564343704", label: "WhatsApp" },
            ...
            <ul className="mt-6 space-y-2 text-[15px]" style={{ color: creamSoft }}>
              ...
              <li>
                <a
                  href="https://wa.me/966564343704?text=%D8%A7%D9%84%D8%B3%D9%84%D8%A7%D9%85%20%D8%B9%D9%84%D9%8A%D9%83%D9%85%D8%8C%20%D8%A3%D9%88%D8%AF%20%D8%A7%D9%84%D8%AA%D9%88%D8%A7%D8%B5%D9%84%20%D9%85%D8%B9%20%D8%AA%D9%90%D9%83%D9%84%D9%87"
                  target="_blank"
