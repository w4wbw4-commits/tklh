...
export const SiteMenuSheet = ({ isPrimaryAdmin, triggerTheme = "green" }: Props) => {
  ...
  const accountLinks: NavLinkItem[] = [
    { type: "route", href: "/dashboard", icon: LayoutDashboard, labelKey: "nav.myDashboard", fallback: { ar: "متابعة الخطة", en: "Follow-up Plan" }, disabled: true, badge: { ar: "قريبًا", en: "Soon" } },
    { type: "route", href: "/partner/login", icon: Building2, labelKey: "nav.joinAsVendor", fallback: { ar: "سجل دخول كمزود خدمة", en: "Join as Vendor" } },
    ...(isPrimaryAdmin
