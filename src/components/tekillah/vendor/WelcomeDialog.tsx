      ...
      <DialogContent dir="rtl" className="max-w-md">
        ...
        <div className={`mt-2 flex items-start gap-3 rounded-2xl border p-4 ${
          ...
          <p className="text-sm text-foreground/80">
            {isPending
              ? "ملفك الآن قيد المراجعة. تستطيع تصفّح اللوحة وإعداد الباقات والتسعير، وستفعّل الحجوزات فور الاعتماد."
              : "حسابك مفعّل ويظهر للعملاء — تفقّد طلبات الحجز الجديدة فور وصولها."}
          </p>
        </div>
